...
/**
 * Internal result type from WASM layer (discriminated union).
 * @internal This type is used internally to parse WASM responses.
 */
export interface BundleTaskResult {
