/* @ts-self-types="./fob_mdx_wasm.d.ts" */
 ...
 * @returns {any}
 */
function compile_mdx(source, options) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.compile_mdx = compile_mdx;
...
const wasmPath = `${__dirname}/fob_mdx_wasm_bg.wasm`;
