...
//!
//! This crate provides the `Analyzer` API and related analysis functionality
...
pub struct AnalyzeOptions {
    ...
    pub framework_rules: Vec<Box<dyn fob_graph::FrameworkRule>>,
...
///
/// ```rust,ignore
/// use fob_analysis::{analyze_with_options, AnalyzeOptions};
