...
#[cfg(feature = "bundler")]
use crate::builders::unified::builder::Builder;
...
#[tokio::test]
#[cfg(feature = "bundler")]
async fn test_analyzer_vs_builder_same_graph() {
...
#[tokio::test]
#[cfg(feature = "bundler")]
async fn test_builder_analyze_only() {
    let temp = TempDir::new().unwrap();
    let root = create_simple_ts_project(&temp);
    let runtime = Arc::new(TestRuntime::new(root.clone()));
...
#[tokio::test]
#[cfg(feature = "bundler")]
async fn test_builder_analyze_only_respects_config() {
    let temp = TempDir::new().unwrap();
