...
pub fn init_logger(verbose: bool, quiet: bool, no_color: bool) {
    ...
    let filter = if verbose {
        ...
        EnvFilter::new("fob=debug,fob_bundler=debug,fob_cli=debug")
    } else if quiet {
        ...
        EnvFilter::try_from_default_env()
            .unwrap_or_else(|_| EnvFilter::new("fob=info,fob_bundler=info"))
    };
...
mod tests {
    ...
    fn test_env_filter_verbose() {
        ...
        let _filter = EnvFilter::new("fob=debug,fob_bundler=debug,fob_cli=debug");
