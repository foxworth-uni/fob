...
pub struct BuildResult {
    ...
    pub analysis: crate::analysis::AnalysisResult,

    /// Cache effectiveness metrics.
    pub cache: crate::analysis::CacheAnalysis,

    /// Transformation trace (when JOY_TRACE env var is set).
    pub trace: Option<crate::analysis::TransformationTrace>,
...
impl BuildResult {
    ...
    pub fn analysis(&self) -> &crate::analysis::AnalysisResult {
        &self.analysis
    }
    ...
    pub fn cache(&self) -> &crate::analysis::CacheAnalysis {
        &self.cache
    }

    /// Access transformation trace (if enabled via JOY_TRACE).
    pub fn trace(&self) -> Option<&crate::analysis::TransformationTrace> {
        self.trace.as_ref()
    }
