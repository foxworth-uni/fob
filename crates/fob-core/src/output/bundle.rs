...
use crate::analysis::{AnalysisResult, AnalyzedBundle, CacheAnalysis, TransformationTrace};
use crate::graph::{GraphStatistics, ModuleGraph, ModuleId};
...
impl Bundle {
    pub(crate) fn from_analyzed(inner: AnalyzedBundle) -> Self {
        Self { inner }
    }
